...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public interface IStationsApi : IApiAccessor
    {
        ...
        ApiResponse<StationSettings> GetStationsSettingsWithHttpInfo ();
        ...
        /// <returns>StationSettings</returns>
        StationSettings PatchStationsSettings (StationSettings body);
        ...
        /// <param name="body">Station settings</param>
        /// <returns>ApiResponse of StationSettings</returns>
        ApiResponse<StationSettings> PatchStationsSettingsWithHttpInfo (StationSettings body);
        ...
        System.Threading.Tasks.Task<StationSettings> GetStationsSettingsAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<StationSettings>> GetStationsSettingsAsyncWithHttpInfo ();
        ...
        /// <param name="body">Station settings</param>
        /// <returns>Task of StationSettings</returns>
        System.Threading.Tasks.Task<StationSettings> PatchStationsSettingsAsync (StationSettings body);
        ...
        /// <param name="body">Station settings</param>
        /// <returns>Task of ApiResponse (StationSettings)</returns>
        System.Threading.Tasks.Task<ApiResponse<StationSettings>> PatchStationsSettingsAsyncWithHttpInfo (StationSettings body);
    ...
    public partial class StationsApi : IStationsApi
    {
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>StationSettings</returns>
        public StationSettings GetStationsSettings ()
        {
             ApiResponse<StationSettings> localVarResponse = GetStationsSettingsWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of StationSettings</returns>
        public ApiResponse< StationSettings > GetStationsSettingsWithHttpInfo ()
        { 

            var localVarPath = "/api/v2/stations/settings";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<Tuple<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetStationsSettings: " + localVarResponse.Content, localVarResponse.Content, localVarHeaders);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling GetStationsSettings: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of StationSettings</returns>
        public async System.Threading.Tasks.Task<StationSettings> GetStationsSettingsAsync ()
        {
             ApiResponse<StationSettings> localVarResponse = await GetStationsSettingsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (StationSettings)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StationSettings>> GetStationsSettingsAsyncWithHttpInfo ()
        { 
        ...
        /// <param name="body">Station settings</param>
        /// <returns>StationSettings</returns>
        public StationSettings PatchStationsSettings (StationSettings body)
        {
             ApiResponse<StationSettings> localVarResponse = PatchStationsSettingsWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">Station settings</param>
        /// <returns>ApiResponse of StationSettings</returns>
        public ApiResponse< StationSettings > PatchStationsSettingsWithHttpInfo (StationSettings body)
        { 
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling StationsApi->PatchStationsSettings");
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PatchStationsSettings: " + localVarResponse.Content, localVarResponse.Content, localVarHeaders);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling PatchStationsSettings: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="body">Station settings</param>
        /// <returns>Task of StationSettings</returns>
        public async System.Threading.Tasks.Task<StationSettings> PatchStationsSettingsAsync (StationSettings body)
        {
             ApiResponse<StationSettings> localVarResponse = await PatchStationsSettingsAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Station settings</param>
        /// <returns>Task of ApiResponse (StationSettings)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StationSettings>> PatchStationsSettingsAsyncWithHttpInfo (StationSettings body)
        { 
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling StationsApi->PatchStationsSettings");
